...
//+kubebuilder:rbac:groups=lindb.lindb.io,resources=brokers,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=lindb.lindb.io,resources=brokers/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=lindb.lindb.io,resources=brokers/finalizers,verbs=update
